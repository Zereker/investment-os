...
Karpathy-rules for long-term investing: one [Agent skill](plugins/investment-os/skills/using-investment-os/SKILL.md), four policy references, and deterministic fact, math, and execution controls.
