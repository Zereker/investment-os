...
def main() -> None:
    ...
    require("scripts/daily_brief.py", 'UNIVERSE = ("SPYM", "QQQM", "SOXX")', "DATA INCOMPLETE", "Why Not the Others", "never writes inputs or output to disk", "build_packet", "render_packet", "--packet-json")
    require("scripts/decision_packet.py", "class DecisionPacket", "assert_renderer_preserves", "renderer changed authoritative field", "execution_authority")
