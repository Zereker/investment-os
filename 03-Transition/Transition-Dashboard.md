...
- Cash 目标：15%（12%–18%）
- QQQM 目标：28%（25%–31%）
- Alpha 机会预算 \(A\)：0%–15%，含 Observation
- SPYM 目标：`57%−A`
- `SPYM + Alpha` 袖套：57%（54%–60%）
- 单一 Alpha：不超过 6%；Alpha 最多 5 只
- 每月新增投入：2,000 美元
- 战略基线计划完成月：2028-12
...
|---|---|---:|---:|---|
| SOXX | Observation | 从 IBKR 读取 | $0 | `HOLD — ADD FROZEN` |
...
| 通道 | 当月金额 | 目标 | 所需闸门 |
|---|---:|---|---|
| Routine DCA | \(D\)，默认 $2,000 | SPYM / QQQM 正缺口 | 月度 Data / Execution Gate |
