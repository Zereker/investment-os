...
聊天记录、旧报告、截图、人工贴数和 [source repository research](https://github.com/Zereker/investment-os/tree/master/Research/) 不具有 Production 规则效力。`project-contract.md` 定义产品边界，`agent-execution-contract.md` 定义 Agent 运行程序；二者不得覆盖上述投资规则。
